...
package.domain = org.ivn

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,jpeg,kv,atlas,db,ttf,otf,json,txt,env
...
source.exclude_dirs = .git,.idea,.venv,.venv-linux,bin,__pycache__
...
android.permissions = android.permission.INTERNET,android.permission.WAKE_LOCK,android.permission.POST_NOTIFICATIONS,android.permission.SCHEDULE_EXACT_ALARM
...
# android.extra_manifest_application_arguments = <receiver android:name="org.kivy.android.PythonBroadcastReceiver" android:exported="false" />
